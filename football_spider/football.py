                    ...
                    for each in YAPAN:
                        ...
                        if yapan1 == each.split('-')[0] and yapan2 == each.split('-')[1]:
                            try:
                                ...
                                pass
                            print ''
                            print now, myAlign(ftype, 8), gamestarttime, gamestatus, myAlign(team1, 15), score, myAlign(team2, 15), halfscore, yapan1, yapan2, u'设置好的数字:', each.split('-')[0], each.split('-')[1]
                    for each in DAXIAOPAN:
                        ...
                        if daxiaopan1 == each.split('-')[0] and daxiaopan2 == each.split('-')[1]:
                            try:
                                ...
                                pass
                            print ''
                            print now, myAlign(ftype, 8), gamestarttime, gamestatus, myAlign(team1, 15), score, myAlign(team2, 15), halfscore, daxiaopan1, daxiaopan2, u'设置好的数字:', each.split('-')[0], each.split('-')[1]
        time.sleep(10)
